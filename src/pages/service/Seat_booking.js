...
import { handleBookRideRegistration } from '../../components/hooks/bookingRide';

const Seat_booking = ({ vehicleId, sendSource, sendDestination }) => {
  ...
  return (
    <div className='container-ticket'>
      ...
      <button className='btn-booking' id='btn' onClick={() => { handleBookingdata() }}>Book now</button>
    </div>
  );
};

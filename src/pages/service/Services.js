...
export default function Service() {
  ...
  return (
    ...
    < >
      ...
      <div className="bg-cover bg-center h-screen flex items-center" style={{ backgroundImage: 'url(/outsideP3.jpg)' }} >
          ...
          <div className='Card_bus-service'>
            <div>
              <Card_bus source={SourceRef.current.value} destination={DestinationRef.current.value}
                scordinate={source} dcordinate={destination} place="outside" vehicleData={vehicleData} />
            </div>
          </div>}
      </section>
      <Footer />

...
export default function Map(props) {
  ...
  return (
    <>
      {mapexpand ? <div className="map-conatiner-flex  w-[100%] md:w-[500px]">
        ...
        <div className="newmapcontainer">
          <Expand source={[source[1], source[0]]} destination={[destination[1], destination[0]]} place={props.place} handleClick={handleClick} />
